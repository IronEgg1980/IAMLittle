...
public class PersonDetailsTempAdapter extends RecyclerView.Adapter {
    ...
    public PersonDetailsTempAdapter(List<ItemEntity> list){
        this.mList = list;
    }
    @Override
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        switch (type){
            ...
            case 1:// father
                ...
                final ItemEntityJXGZPersonTotalTemp personTotal = (ItemEntityJXGZPersonTotalTemp) itemEntity;
                int scale = personTotal.getList().get(0).getScale();
                holder2.nameTV.setText(personTotal.getPersonName());
                holder2.totalAmountTV.setText(personTotal.getAmountString(scale));
            ...
            case 2:// child
                ...
                ItemEntityJXGZPersonDetailsTemp personDetails = (ItemEntityJXGZPersonDetailsTemp) itemEntity;
            ...
            case 3:// details
                ...
                ItemEntityJXGZTotalDetailsTemp totalDetails = (ItemEntityJXGZTotalDetailsTemp) itemEntity;
