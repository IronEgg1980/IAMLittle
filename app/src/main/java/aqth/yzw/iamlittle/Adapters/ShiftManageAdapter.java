...
public class ShiftManageAdapter extends RecyclerView.Adapter {
    ...
    protected class ShiftVieHolder extends RecyclerView.ViewHolder{
        ...
        public ShiftVieHolder(@NonNull View itemView) {
            ...
            emptyTV = itemView.findViewById(R.id.shift_recyclerview_item_empty);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
           if (i == ADDBUTTON){
               View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recyclerview_addbutton_layout,viewGroup,false);
               return new RecyclerViewAddButtonViewHolder(v);
           }else{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if (itemType == ItemType.EMPTY){
            RecyclerViewAddButtonViewHolder viewHolder1 = (RecyclerViewAddButtonViewHolder)viewHolder;
            viewHolder1.getButton().setText("新增班次");
            viewHolder1.getButton().setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            vieHolder2.emptyTV.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    shiftItemClickListener.onClick(v,i);
                }
            ...
            if(type == MyTool.SHIFT_NORMAL){
                vieHolder2.danweijine.setVisibility(View.INVISIBLE);
                ...
                vieHolder2.typeTextTV.setText("类型：请假");
                vieHolder2.unitAmountTV.setText("");
            }else{
                vieHolder2.danweijine.setVisibility(View.VISIBLE);
